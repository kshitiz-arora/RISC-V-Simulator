...
def decode(instr):
    ...
    if (variable == {'opcode': '0110011', 'funct3': '001', 'funct7': '0000000', 'rd': '01000', 'rs1': '00110', 'rs2': '10110', 'instr_type': '', 'operation': ''}):
        kewt = 1
        print("flag")
...
while register_counter != -2:
    main1()

print(registers)
for i in range(0x10000000, 0x1000001c, 4):
    print(hex(i), memory[i])